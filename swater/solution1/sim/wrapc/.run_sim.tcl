...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "compute_matrices.autotvin.dat"
	set constFileTvOut       "compute_matrices.autotvout.dat"
	set constFileHdlTvIn     "compute_matrices.autohdltvin.dat"
	set constFileHdlTvOut    "compute_matrices.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
