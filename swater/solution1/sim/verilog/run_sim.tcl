...
if {[file isfile compute_matrices.autotvin.dat]} {
	file delete -force compute_matrices.autotvin.dat
}

if {[file isfile compute_matrices.autotvout.dat]} {
	file delete -force compute_matrices.autotvout.dat
}
