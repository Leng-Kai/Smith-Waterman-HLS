...
module AESL_axi_master_gmem0 (
    ...
    TRAN_gmem0_BID,
    TRAN_gmem0_BUSER,
    TRAN_gmem0_string1_g_V,
    TRAN_gmem0_string2_g_V,
    ready,
    done
    );

//------------------------Parameter----------------------
`define TV_IN_gmem0 "../tv/cdatafile/c.compute_matrices.autotvin_gmem0.dat"
`define TV_OUT_gmem0 "../tv/rtldatafile/rtl.compute_matrices.autotvout_gmem0.dat"
 parameter gmem0_ADDR_BITWIDTH = 32'd 32;
...
output [32 - 1 : 0] TRAN_gmem0_string1_g_V;
output [32 - 1 : 0] TRAN_gmem0_string2_g_V;
input ready;
input done;
...
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [32 - 1 : 0] string1_g_V = 0;
reg [32 - 1 : 0] string2_g_V = 0;
...
assign    TRAN_gmem0_string1_g_V = string1_g_V;
assign    TRAN_gmem0_string2_g_V = string2_g_V;
...
initial begin : initialize_offset
  ...
  string1_g_V <= 0 * DATA_byte_num;
  string2_g_V <= 32 * DATA_byte_num;
end
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem0_mem_depth) begin
                $display ("C:/WorkZone/ZedBoard/swater_4/solution1/sim/verilog/AESL_axi_master_gmem0.v: Write request address %d exceed AXI master gmem0 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem0_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem0_mem_depth) begin
                $display ("C:/WorkZone/ZedBoard/swater_4/solution1/sim/verilog/AESL_axi_master_gmem0.v: Read request address %d exceed AXI master gmem0 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem0_mem_depth); 
                $finish;
            end
