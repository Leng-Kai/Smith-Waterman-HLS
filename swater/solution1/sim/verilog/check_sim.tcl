...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.compute_matrices.autotvin_gmem0.dat"
         "c.compute_matrices.autotvin_string1_g_V.dat"
         "c.compute_matrices.autotvin_string2_g_V.dat"
         "c.compute_matrices.autotvin_direction_matrix_g_V.dat"
         "c.compute_matrices.autotvout_gmem1.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.compute_matrices.autotvout_gmem1.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
