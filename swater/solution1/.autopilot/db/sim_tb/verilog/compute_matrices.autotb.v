...
`define AUTOTB_DUT      compute_matrices
`define AUTOTB_DUT_INST AESL_inst_compute_matrices
`define AUTOTB_TOP      apatb_compute_matrices_top
`define AUTOTB_LAT_RESULT_FILE "compute_matrices.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "compute_matrices.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_compute_matrices_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_gmem0 1
`define AESL_DEPTH_gmem1 1
`define AESL_DEPTH_string1_g_V 1
`define AESL_DEPTH_string2_g_V 1
`define AESL_DEPTH_direction_matrix_g_V 1
`define AUTOTB_TVIN_gmem0  "./c.compute_matrices.autotvin_gmem0.dat"
`define AUTOTB_TVIN_string1_g_V  "./c.compute_matrices.autotvin_string1_g_V.dat"
`define AUTOTB_TVIN_string2_g_V  "./c.compute_matrices.autotvin_string2_g_V.dat"
`define AUTOTB_TVIN_direction_matrix_g_V  "./c.compute_matrices.autotvin_direction_matrix_g_V.dat"
`define AUTOTB_TVIN_gmem0_out_wrapc  "./rtl.compute_matrices.autotvin_gmem0.dat"
`define AUTOTB_TVIN_string1_g_V_out_wrapc  "./rtl.compute_matrices.autotvin_string1_g_V.dat"
`define AUTOTB_TVIN_string2_g_V_out_wrapc  "./rtl.compute_matrices.autotvin_string2_g_V.dat"
`define AUTOTB_TVIN_direction_matrix_g_V_out_wrapc  "./rtl.compute_matrices.autotvin_direction_matrix_g_V.dat"
`define AUTOTB_TVOUT_gmem1  "./c.compute_matrices.autotvout_gmem1.dat"
`define AUTOTB_TVOUT_gmem1_out_wrapc  "./impl_rtl.compute_matrices.autotvout_gmem1.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 10;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 231;
parameter LENGTH_gmem0 = 64;
parameter LENGTH_gmem1 = 160;
parameter LENGTH_string1_g_V = 1;
parameter LENGTH_string2_g_V = 1;
parameter LENGTH_direction_matrix_g_V = 1;
...
wire [32 - 1:0] string1_g_V;
wire [32 - 1:0] string2_g_V;
AESL_axi_master_gmem0 AESL_AXI_MASTER_gmem0(
    ...
    .TRAN_gmem0_string1_g_V (string1_g_V),
    .TRAN_gmem0_string2_g_V (string2_g_V),
...
wire [32 - 1:0] direction_matrix_g_V;
AESL_axi_master_gmem1 AESL_AXI_MASTER_gmem1(
    ...
    .TRAN_gmem1_direction_matrix_g_V (direction_matrix_g_V),
...
AESL_axi_slave_control AESL_AXI_SLAVE_control(
    ...
    .TRAN_string1_g_V (string1_g_V),
    .TRAN_string2_g_V (string2_g_V),
    .TRAN_direction_matrix_g_V (direction_matrix_g_V),
...
reg end_string1_g_V;
reg [31:0] size_string1_g_V;
reg [31:0] size_string1_g_V_backup;
reg end_string2_g_V;
reg [31:0] size_string2_g_V;
reg [31:0] size_string2_g_V_backup;
reg end_direction_matrix_g_V;
reg [31:0] size_direction_matrix_g_V;
reg [31:0] size_direction_matrix_g_V_backup;
reg end_gmem1;
reg [31:0] size_gmem1;
...
initial begin : dump_tvout_runtime_sign_gmem1
    ...
    fp = $fopen(`AUTOTB_TVOUT_gmem1_out_wrapc, "w");
    if (fp == 0) begin
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_gmem1_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_gmem1_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
